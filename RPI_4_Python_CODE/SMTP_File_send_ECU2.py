...
def SendAttachFile():
        ...
        msg['From'] = fromaddr
        msg['To'] = toaddr
        msg['Subject'] = "iCAR Health Data: ECU 2"
        body = "Attachment Sheet containes => Temperature sensor and pressure sensor data"
...
print("iCAR+100 for Sending Car Health Data ECU 2..........................")
